...
describe('AgentManager', () => {
  ...
  describe('createAgent', () => {
    ...
    it('should throw an error if agent already exists', async () => {
      ...
      await expect(agentManager.createAgent('existing-agent', DEFAULT_CODE_ASSISTANT))
    ...
    it('should validate tool references', async () => {
      ...
      await expect(agentManager.createAgent('new-agent', mockAgent))
        .rejects.toThrow(/Referenced tool 'nonexistent-tool' not found/);
    });
  });
  ...
  describe('updateAgent', () => {
    ...
    it('should throw an error if agent does not exist', async () => {
      ...
      await expect(agentManager.updateAgent('nonexistent', { description: 'New description' }))
        .rejects.toThrow(/not found or invalid/);
    });
  });
