...
export const searchReplaceV2Tool: Tool = {
  ...
  parameters: z.object({
    ...
    diff: z.string().describe('The search/replace block defining the changes in the format: <<<<<<< SEARCH\\n[content]\\n=======\\n[content]\\n>>>>>>> REPLACE'),
    ...
    fuzzy_threshold: z.number().optional().describe('Similarity threshold for fuzzy matching (0.0-1.0, where 1.0 is exact match)')
  }),
