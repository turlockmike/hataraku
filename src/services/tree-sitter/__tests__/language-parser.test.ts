...
describe('Language Parser', () => {
  ...
  describe('loadRequiredLanguageParsers', () => {
    ...
    it('should load JavaScript parser for .js and .jsx files', async () => {
      ...
      expect(ParserMock.Language.load).toHaveBeenCalledWith(expect.stringContaining('tree-sitter-javascript.wasm'))
    ...
    it('should load TypeScript parser for .ts and .tsx files', async () => {
      ...
      expect(ParserMock.Language.load).toHaveBeenCalledWith(expect.stringContaining('tree-sitter-typescript.wasm'))
