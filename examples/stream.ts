...
async function main() {
  ...
  try {
    ...
    const result = await agent.task(
      "Write a detailed epic poem (at least 5 lines) about a programmer's journey through learning artificial intelligence, with rich metaphors comparing coding concepts to natural phenomena. Include specific mentions of neural networks, machine learning algorithms, and the emotional journey of discovery.",
      { stream: true },
    )
