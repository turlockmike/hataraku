...
- `task(task: string, input?: TaskInput & { stream: true }): Promise<AsyncIterableStream<string>>` - Get a streaming
  response
...
- `run(input: TInput, options: { stream: true, thread?: Thread }): Promise<AsyncIterableStream<string>>` - Get a
  streaming response
